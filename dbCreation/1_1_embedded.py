...
def definingValues():
    dataTypesArray = ["String","Integer","Boolean","Double","Timestamp", "Array"]
    dataType = random.choice(dataTypesArray)
...
for k in range(0,documents_quantity,range_intervals):
    for i in range(range_intervals):
        ...
        toInsert.append(A)
        collection_A1.insert_many(toInsert)
